...
def index(request):
        ...
        return render_to_response('pagefetch/index.html', context)
...
def play(request, category_name):
        ...
        if request.COOKIES.has_key('game_id'):
            ...
            response = HttpResponseRedirect('/pagefetch/pick_category/')
            # delete the cookie
...
def pick_category(request):
        ...
        msg = avatar.get()
        response = render_to_response('pagefetch/cat_picker.html', {'cats': cats, 'avatar': msg}, context)
        response.delete_cookie('game_id')
        return response
...
def game_over(request):
    ...
    if request.COOKIES.has_key('game_id'):
        ...
        return render_to_response('pagefetch/game_over.html', context)



def about(request):
    context = RequestContext(request, {})
    return render_to_response('pagefetch/about.html', context)
