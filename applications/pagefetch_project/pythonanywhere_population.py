...
def highscores():
    HighScore(user=User.objects.filter(username='Jim')[0],category=Category.objects.filter(name="Films")[0],highest_score=2566).save()
    HighScore(user=User.objects.filter(username='Jim')[0],category=Category.objects.filter(name="Actors")[0],highest_score=3200).save()
    ...
    HighScore(user=User.objects.filter(username='Jim')[0],category=Category.objects.filter(name="Universities")[0],highest_score=500).save()
