...
from configuration import STATIC_PATH, MEDIA_PATH, MEDIA_URL, UPLOAD_DIR, MEDIA_ROOT
...
SECRET_KEY = '7@(z19e20dm^03llz2biisgv7()au7(1rw-gl%&t#jf(b*0j45'
...
ROOT_URLCONF = 'pagefetch_project.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'pagefetch_project.wsgi.application'
