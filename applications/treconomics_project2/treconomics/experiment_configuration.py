...
exp_work_flows = [
    ...
    ['/treconomics/startexperiment/','/treconomics/preexperiment/UK/',
        ...
        '/treconomics/anitapretasksurvey/3/','/treconomics/search/3/','/treconomics/anitaposttask1survey/3/','/treconomics/anitaposttask2survey/3/','/treconomics/anitaposttask3survey/3/',
        '/treconomics/anitapretasksurvey/4/','/treconomics/search/4/','/treconomics/anitaposttask1survey/4/','/treconomics/anitaposttask2survey/4/','/treconomics/anitaposttask3survey/4/',
        '/treconomics/anitaexit1survey/','/treconomics/anitademographicssurvey/','/treconomics/logout/'],
]
