...
exp_slow_low = ExperimentSetup(workflow=exp_work_flows[0], timeout=5, engine=tfidfor, topics=['347', '435', ], rpp=10, interface=0, description='standard condition tfidf delay', delay_results=7, trie=suggestion_trie, autocomplete=True)
