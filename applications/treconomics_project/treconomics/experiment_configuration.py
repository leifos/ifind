...
'/treconomics/pretaskquestions/1/','/treconomics/searcha/1/','/treconomics/posttaskquestions/1/',
 ...
 '/treconomics/conceptlistingsurvey/1/PRE/','/treconomics/conceptlistingsurvey/2/PRE/','/treconomics/performance/','/treconomics/logout/'],
...
exp_fast_high = ExperimentSetup(workflow=exp_work_flows[0], engine=new_engine, topics=['347', '435', ], rpp=10, interface=0, description='standard condition PL2 no delay', trie=suggestion_trie, autocomplete=True)
exp_slow_high = ExperimentSetup(workflow=exp_work_flows[0], engine=new_engine, topics=['347', '435', ], rpp=10, interface=0, description='standard condition PL2 query delay', delay_results=5, trie=suggestion_trie, autocomplete=True)
exp_fast_low = ExperimentSetup(workflow=exp_work_flows[0], engine=new_engine, topics=['347', '435', ], rpp=10, interface=0, description='standard condition PL2 doc delay', delay_docview=5, trie=suggestion_trie, autocomplete=True)
