...
exp_test = ExperimentSetup(workflow=exp_work_flows[0], engine=bm25, practice_topic='341', topics=['347', '367', '354' ], rpp=10, practice_interface=1, interface=[1,2,3], rotation_type=1, description='standard condition bm25 test', trie=suggestion_trie, autocomplete=True, timeout=300)
